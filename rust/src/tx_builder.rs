...
pub fn get_ex_units(
    ...
    // println!("utxos_bytes: {:?}", utxos_bytes);
    // println!("cost_mdls_bytes: {:?}", cost_mdls_bytes);
    // println!("initial_budget: {:?}", initial_budget);
    // println!("sc: {:?}", sc);
...
mod tests {
    ...
    fn test_get_ex_unit_hello_world() {
        let transaction = Transaction::from_hex("").unwrap();

        println!("{}", transaction.to_json().unwrap());


        let cost_model = Costmdls::from_hex("").unwrap();
        let mut utxos = TransactionUnspentOutputs::new();
        utxos.add(
            &TransactionUnspentOutput::from_hex("82825820f9f20ccfb71ea613e47e40d2fd3a92bd642daf6eb107a1330da5ed16e6f3b67a018258390012a6dec5d7d56054d7526d775a0c7dea5610b933a278e61708667d46591e78045d4271a196916ccd1012f6642c9d8a5c453c1b5f0dc9655f1b000000298de962bc").unwrap()
        );
        let max_ex_units = ExUnits::from_hex("821a00d59f801b00000002540be400").unwrap();
        let redeemer = get_ex_units(
            &transaction,
            &utxos,
            &cost_model,
            &max_ex_units,
            BigNum::from_str("1655769600000").unwrap(),
            BigNum::from_str("86400").unwrap(),
            1000
        ).unwrap();
